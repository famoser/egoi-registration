...
class SampleService implements SampleServiceInterface
{
    ...
    public function createSampleConstructionSite(string $sampleName, Participant $constructionManager): ConstructionSite
    {
    ...
    private function addIssues(ConstructionSite $constructionSite, Participant $constructionManager, string $path): void
    {
