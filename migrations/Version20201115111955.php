 ...
 */
final class Version20201115111955 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__participant AS SELECT id, delegation_id, role, created_at, last_changed_at, given_name, family_name, birthday, email, phone, personal_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, passport_image, country_of_residence, place_of_birth, immigration_review_progress, diet, allergies, event_presence_review_progress, gender, name_on_egoidocuments, portrait FROM participant');
        ...
        , role INTEGER NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, given_name CLOB DEFAULT NULL COLLATE BINARY, family_name CLOB DEFAULT NULL COLLATE BINARY, birthday DATETIME DEFAULT NULL, email CLOB DEFAULT NULL COLLATE BINARY, phone CLOB DEFAULT NULL COLLATE BINARY, personal_data_review_progress INTEGER NOT NULL, nationality CLOB DEFAULT NULL COLLATE BINARY, passport_number CLOB DEFAULT NULL COLLATE BINARY, passport_validity_from DATE DEFAULT NULL, passport_validity_to DATE DEFAULT NULL, passport_issue_country CLOB DEFAULT NULL COLLATE BINARY, passport_image VARCHAR(255) DEFAULT NULL COLLATE BINARY, country_of_residence CLOB DEFAULT NULL COLLATE BINARY, place_of_birth CLOB DEFAULT NULL COLLATE BINARY, immigration_review_progress INTEGER NOT NULL, diet CLOB DEFAULT NULL COLLATE BINARY, allergies CLOB DEFAULT NULL COLLATE BINARY, event_presence_review_progress INTEGER NOT NULL, gender INTEGER DEFAULT NULL, portrait CLOB DEFAULT NULL COLLATE BINARY, name_on_documents CLOB DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_D79F6B1156CBBCF5 FOREIGN KEY (delegation_id) REFERENCES delegation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO participant (id, delegation_id, role, created_at, last_changed_at, given_name, family_name, birthday, email, phone, personal_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, passport_image, country_of_residence, place_of_birth, immigration_review_progress, diet, allergies, event_presence_review_progress, gender, name_on_documents, portrait) SELECT id, delegation_id, role, created_at, last_changed_at, given_name, family_name, birthday, email, phone, personal_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, passport_image, country_of_residence, place_of_birth, immigration_review_progress, diet, allergies, event_presence_review_progress, gender, name_on_egoidocuments, portrait FROM __temp__participant');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_E7927C74A45BB98C ON email (sent_by_id)');
        $this->addSql('DROP INDEX IDX_D79F6B1156CBBCF5');
        $this->addSql('CREATE TEMPORARY TABLE __temp__participant AS SELECT id, delegation_id, role, created_at, last_changed_at, given_name, family_name, birthday, email, phone, gender, name_on_documents, portrait, personal_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, passport_image, country_of_residence, place_of_birth, immigration_review_progress, diet, allergies, event_presence_review_progress FROM participant');
        $this->addSql('DROP TABLE participant');
        $this->addSql('CREATE TABLE participant (id CHAR(36) NOT NULL --(DC2Type:guid)
        , delegation_id CHAR(36) DEFAULT NULL --(DC2Type:guid)
        , role INTEGER NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, given_name CLOB DEFAULT NULL, family_name CLOB DEFAULT NULL, birthday DATETIME DEFAULT NULL, email CLOB DEFAULT NULL, phone CLOB DEFAULT NULL, gender INTEGER DEFAULT NULL, portrait CLOB DEFAULT NULL, personal_data_review_progress INTEGER NOT NULL, nationality CLOB DEFAULT NULL, passport_number CLOB DEFAULT NULL, passport_validity_from DATE DEFAULT NULL, passport_validity_to DATE DEFAULT NULL, passport_issue_country CLOB DEFAULT NULL, passport_image VARCHAR(255) DEFAULT NULL, country_of_residence CLOB DEFAULT NULL, place_of_birth CLOB DEFAULT NULL, immigration_review_progress INTEGER NOT NULL, diet CLOB DEFAULT NULL, allergies CLOB DEFAULT NULL, event_presence_review_progress INTEGER NOT NULL, name_on_egoidocuments CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO participant (id, delegation_id, role, created_at, last_changed_at, given_name, family_name, birthday, email, phone, gender, name_on_egoidocuments, portrait, personal_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, passport_image, country_of_residence, place_of_birth, immigration_review_progress, diet, allergies, event_presence_review_progress) SELECT id, delegation_id, role, created_at, last_changed_at, given_name, family_name, birthday, email, phone, gender, name_on_documents, portrait, personal_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, passport_image, country_of_residence, place_of_birth, immigration_review_progress, diet, allergies, event_presence_review_progress FROM __temp__participant');
        $this->addSql('DROP TABLE __temp__participant');
        $this->addSql('CREATE INDEX IDX_D79F6B1156CBBCF5 ON participant (delegation_id)');
        $this->addSql('DROP INDEX UNIQ_8D93D649E7927C74');
        $this->addSql('DROP INDEX IDX_8D93D64956CBBCF5');
