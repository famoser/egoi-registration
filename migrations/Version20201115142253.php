 ...
 */
final class Version20201115142253 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , delegation_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , arrival_or_departure INTEGER NOT NULL, location VARCHAR(255) NOT NULL COLLATE BINARY, date_time DATETIME NOT NULL, identifier VARCHAR(255) NOT NULL COLLATE BINARY, details VARCHAR(255) DEFAULT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_C56CC37356CBBCF5 FOREIGN KEY (delegation_id) REFERENCES delegation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO travel_group (id, delegation_id, arrival_or_departure, location, date_time, identifier, details, created_at, last_changed_at) SELECT id, delegation_id, arrival_or_departure, location, date_time, identifier, details, created_at, last_changed_at FROM __temp__travel_group');
        $this->addSql('DROP TABLE __temp__travel_group');
        $this->addSql('CREATE INDEX IDX_C56CC37356CBBCF5 ON travel_group (delegation_id)');
        $this->addSql('DROP INDEX IDX_DB3662639D1C3019');
        $this->addSql('DROP INDEX IDX_DB3662639425BA02');
        $this->addSql('CREATE TEMPORARY TABLE __temp__travel_group_participant AS SELECT travel_group_id, participant_id FROM travel_group_participant');
        ...
        , PRIMARY KEY(travel_group_id, participant_id), CONSTRAINT FK_DB3662639425BA02 FOREIGN KEY (travel_group_id) REFERENCES travel_group (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DB3662639D1C3019 FOREIGN KEY (participant_id) REFERENCES participant (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO travel_group_participant (travel_group_id, participant_id) SELECT travel_group_id, participant_id FROM __temp__travel_group_participant');
        $this->addSql('DROP TABLE __temp__travel_group_participant');
