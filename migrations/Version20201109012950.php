 ...
 */
final class Version20201109012950 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , name CLOB NOT NULL COLLATE BINARY, registration_hash VARCHAR(255) NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, athlete_count INTEGER NOT NULL, leader_count INTEGER NOT NULL, guest_count INTEGER NOT NULL, participation_mode INTEGER NOT NULL, attendance_review_progress INTEGER NOT NULL, contribution_review_progress INTEGER NOT NULL, location CLOB DEFAULT NULL COLLATE BINARY, travel_details CLOB DEFAULT NULL COLLATE BINARY, travel_review_progress INTEGER NOT NULL, translations CLOB DEFAULT NULL --(DC2Type:simple_array)
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO delegation (id, name, registration_hash, created_at, last_changed_at, athlete_count, leader_count, guest_count, participation_mode, attendance_review_progress, translations, contribution_review_progress, location, travel_details, travel_review_progress) SELECT id, name, registration_hash, created_at, last_changed_at, athlete_count, leader_count, guest_count, participation_mode, attendance_review_progress, translations, contribution_review_progress, location, travel_details, travel_review_progress FROM __temp__delegation');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , name CLOB NOT NULL, registration_hash VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, athlete_count INTEGER NOT NULL, leader_count INTEGER NOT NULL, guest_count INTEGER NOT NULL, participation_mode INTEGER NOT NULL, attendance_review_progress INTEGER NOT NULL, contribution_review_progress INTEGER NOT NULL, location CLOB DEFAULT NULL, travel_details CLOB DEFAULT NULL, travel_review_progress INTEGER NOT NULL, translations CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO delegation (id, name, registration_hash, created_at, last_changed_at, athlete_count, leader_count, guest_count, participation_mode, attendance_review_progress, translations, contribution_review_progress, location, travel_details, travel_review_progress) SELECT id, name, registration_hash, created_at, last_changed_at, athlete_count, leader_count, guest_count, participation_mode, attendance_review_progress, translations, contribution_review_progress, location, travel_details, travel_review_progress FROM __temp__delegation');
        $this->addSql('DROP TABLE __temp__delegation');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_292F436D5E237E06 ON delegation (name)');
        $this->addSql('DROP INDEX IDX_E7927C74A45BB98C');
