 ...
 */
final class Version20201115080033 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__delegation AS SELECT id, name, registration_hash, created_at, last_changed_at, athlete_count, leader_count, guest_count, participation_mode, attendance_review_progress, contribution_review_progress, location, travel_details, travel_review_progress, translations FROM delegation');
        $this->addSql('DROP TABLE delegation');
        $this->addSql('CREATE TABLE delegation (id CHAR(36) NOT NULL COLLATE BINARY --(DC2Type:guid)
        , name CLOB NOT NULL COLLATE BINARY, registration_hash VARCHAR(255) NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, leader_count INTEGER NOT NULL, guest_count INTEGER NOT NULL, participation_mode INTEGER NOT NULL, attendance_review_progress INTEGER NOT NULL, contribution_review_progress INTEGER NOT NULL, location CLOB DEFAULT NULL COLLATE BINARY, travel_details CLOB DEFAULT NULL COLLATE BINARY, travel_review_progress INTEGER NOT NULL, translations CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:simple_array)
        , contestant_count INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO delegation (id, name, registration_hash, created_at, last_changed_at, contestant_count, leader_count, guest_count, participation_mode, attendance_review_progress, contribution_review_progress, location, travel_details, travel_review_progress, translations) SELECT id, name, registration_hash, created_at, last_changed_at, athlete_count, leader_count, guest_count, participation_mode, attendance_review_progress, contribution_review_progress, location, travel_details, travel_review_progress, translations FROM __temp__delegation');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__participant AS SELECT id, delegation_id, role, created_at, last_changed_at, given_name, family_name, birthday, email, phone, gender, personal_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, passport_image, country_of_residence, place_of_birth, immigration_review_progress, badge_name, badge_image, diet, allergies, event_presence_review_progress FROM participant');
        ...
        , role INTEGER NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, given_name CLOB DEFAULT NULL COLLATE BINARY, family_name CLOB DEFAULT NULL COLLATE BINARY, birthday DATETIME DEFAULT NULL, email CLOB DEFAULT NULL COLLATE BINARY, phone CLOB DEFAULT NULL COLLATE BINARY, gender CLOB DEFAULT NULL COLLATE BINARY, personal_data_review_progress INTEGER NOT NULL, nationality CLOB DEFAULT NULL COLLATE BINARY, passport_number CLOB DEFAULT NULL COLLATE BINARY, passport_validity_from DATE DEFAULT NULL, passport_validity_to DATE DEFAULT NULL, passport_issue_country CLOB DEFAULT NULL COLLATE BINARY, passport_image VARCHAR(255) DEFAULT NULL COLLATE BINARY, country_of_residence CLOB DEFAULT NULL COLLATE BINARY, place_of_birth CLOB DEFAULT NULL COLLATE BINARY, immigration_review_progress INTEGER NOT NULL, badge_name CLOB DEFAULT NULL COLLATE BINARY, badge_image CLOB DEFAULT NULL COLLATE BINARY, diet CLOB DEFAULT NULL COLLATE BINARY, allergies CLOB DEFAULT NULL COLLATE BINARY, event_presence_review_progress INTEGER NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_D79F6B1156CBBCF5 FOREIGN KEY (delegation_id) REFERENCES delegation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_292F436D5E237E06');
        $this->addSql('CREATE TEMPORARY TABLE __temp__delegation AS SELECT id, name, registration_hash, created_at, last_changed_at, contestant_count, leader_count, guest_count, participation_mode, attendance_review_progress, translations, contribution_review_progress, location, travel_details, travel_review_progress FROM delegation');
        $this->addSql('DROP TABLE delegation');
        $this->addSql('CREATE TABLE delegation (id CHAR(36) NOT NULL --(DC2Type:guid)
        , name CLOB NOT NULL, registration_hash VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, leader_count INTEGER NOT NULL, guest_count INTEGER NOT NULL, participation_mode INTEGER NOT NULL, attendance_review_progress INTEGER NOT NULL, translations CLOB DEFAULT NULL --(DC2Type:simple_array)
        , contribution_review_progress INTEGER NOT NULL, location CLOB DEFAULT NULL, travel_details CLOB DEFAULT NULL, travel_review_progress INTEGER NOT NULL, athlete_count INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO delegation (id, name, registration_hash, created_at, last_changed_at, athlete_count, leader_count, guest_count, participation_mode, attendance_review_progress, translations, contribution_review_progress, location, travel_details, travel_review_progress) SELECT id, name, registration_hash, created_at, last_changed_at, contestant_count, leader_count, guest_count, participation_mode, attendance_review_progress, translations, contribution_review_progress, location, travel_details, travel_review_progress FROM __temp__delegation');
        $this->addSql('DROP TABLE __temp__delegation');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_292F436D5E237E06 ON delegation (name)');
        $this->addSql('DROP INDEX IDX_E7927C74A45BB98C');
        $this->addSql('CREATE TEMPORARY TABLE __temp__email AS SELECT id, sent_by_id, identifier, type, sent_date_time, read_at FROM email');
