 ...
 */
final class Version20201104191209 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_D79F6B11F92F3E70');
        $this->addSql('CREATE TEMPORARY TABLE __temp__participant AS SELECT id, country_id, role, created_at, last_changed_at, given_name, family_name, birthday, email, phone, personal_data_review_progress, bade_name, bade_image, diet, allergies, event_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, passport_image, country_of_residence, place_of_birth, immigration_data_review_progress FROM participant');
        ...
        , role INTEGER NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, given_name CLOB DEFAULT NULL COLLATE BINARY, family_name CLOB DEFAULT NULL COLLATE BINARY, birthday CLOB DEFAULT NULL COLLATE BINARY, email CLOB DEFAULT NULL COLLATE BINARY, phone CLOB DEFAULT NULL COLLATE BINARY, personal_data_review_progress INTEGER NOT NULL, bade_name CLOB DEFAULT NULL COLLATE BINARY, bade_image CLOB DEFAULT NULL COLLATE BINARY, diet CLOB DEFAULT NULL COLLATE BINARY, allergies CLOB DEFAULT NULL COLLATE BINARY, event_data_review_progress INTEGER NOT NULL, nationality CLOB DEFAULT NULL COLLATE BINARY, passport_number CLOB DEFAULT NULL COLLATE BINARY, passport_validity_from DATE DEFAULT NULL, passport_validity_to DATE DEFAULT NULL, passport_issue_country CLOB DEFAULT NULL COLLATE BINARY, passport_image VARCHAR(255) DEFAULT NULL COLLATE BINARY, country_of_residence CLOB DEFAULT NULL COLLATE BINARY, place_of_birth CLOB DEFAULT NULL COLLATE BINARY, immigration_data_review_progress INTEGER NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_D79F6B1156CBBCF5 FOREIGN KEY (delegation_id) REFERENCES delegation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO participant (id, delegation_id, role, created_at, last_changed_at, given_name, family_name, birthday, email, phone, personal_data_review_progress, bade_name, bade_image, diet, allergies, event_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, passport_image, country_of_residence, place_of_birth, immigration_data_review_progress) SELECT id, country_id, role, created_at, last_changed_at, given_name, family_name, birthday, email, phone, personal_data_review_progress, bade_name, bade_image, diet, allergies, event_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, passport_image, country_of_residence, place_of_birth, immigration_data_review_progress FROM __temp__participant');
