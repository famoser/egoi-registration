 ...
 */
final class Version20201115202725 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__participant AS SELECT id, delegation_id, arrival_travel_group_id, departure_travel_group_id, role, created_at, last_changed_at, given_name, family_name, birthday, email, phone, personal_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, country_of_residence, place_of_birth, immigration_review_progress, diet, allergies, event_presence_review_progress, gender, portrait, name_on_documents, papers, consent, shirt_size, shirt_fit, single_room FROM participant');
        ...
        $this->addSql('INSERT INTO participant (id, delegation_id, arrival_travel_group_id, departure_travel_group_id, role, created_at, last_changed_at, given_name, family_name, birthday, email, phone, personal_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, country_of_residence, place_of_birth, immigration_review_progress, diet, allergies, event_presence_review_progress, gender, portrait, name_on_documents, papers, consent, shirt_size, shirt_fit, single_room) SELECT id, delegation_id, arrival_travel_group_id, departure_travel_group_id, role, created_at, last_changed_at, given_name, family_name, birthday, email, phone, personal_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, country_of_residence, place_of_birth, immigration_review_progress, diet, allergies, event_presence_review_progress, gender, portrait, name_on_documents, papers, consent, shirt_size, shirt_fit, single_room FROM __temp__participant');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__travel_group AS SELECT id, delegation_id, arrival_or_departure, location, date_time, created_at, last_changed_at, provider, description, trip_number FROM travel_group');
        $this->addSql('DROP TABLE travel_group');
        $this->addSql('CREATE TABLE travel_group (id CHAR(36) NOT NULL COLLATE BINARY --(DC2Type:guid)
        , delegation_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , arrival_or_departure INTEGER NOT NULL, location VARCHAR(255) NOT NULL COLLATE BINARY, date_time DATETIME NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, provider VARCHAR(255) NOT NULL COLLATE BINARY, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, trip_number VARCHAR(255) NOT NULL COLLATE BINARY, review_progress INTEGER NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_C56CC37356CBBCF5 FOREIGN KEY (delegation_id) REFERENCES delegation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO travel_group (id, delegation_id, arrival_or_departure, location, date_time, created_at, last_changed_at, provider, description, trip_number) SELECT id, delegation_id, arrival_or_departure, location, date_time, created_at, last_changed_at, provider, description, trip_number FROM __temp__travel_group');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_D79F6B113E0872DC');
        $this->addSql('DROP INDEX IDX_D79F6B113F2C9D61');
        $this->addSql('CREATE TEMPORARY TABLE __temp__participant AS SELECT id, delegation_id, arrival_travel_group_id, departure_travel_group_id, role, created_at, last_changed_at, given_name, family_name, birthday, email, gender, name_on_documents, portrait, papers, consent, personal_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, country_of_residence, place_of_birth, immigration_review_progress, phone, shirt_size, shirt_fit, diet, allergies, single_room, event_presence_review_progress FROM participant');
        $this->addSql('DROP TABLE participant');
        ...
        $this->addSql('CREATE INDEX IDX_D79F6B113F2C9D61 ON participant (departure_travel_group_id)');
        $this->addSql('DROP INDEX IDX_C56CC37356CBBCF5');
        $this->addSql('CREATE TEMPORARY TABLE __temp__travel_group AS SELECT id, delegation_id, arrival_or_departure, location, date_time, provider, trip_number, description, created_at, last_changed_at FROM travel_group');
        $this->addSql('DROP TABLE travel_group');
        $this->addSql('CREATE TABLE travel_group (id CHAR(36) NOT NULL --(DC2Type:guid)
        , delegation_id CHAR(36) DEFAULT NULL --(DC2Type:guid)
        , arrival_or_departure INTEGER NOT NULL, location VARCHAR(255) NOT NULL, date_time DATETIME NOT NULL, provider VARCHAR(255) NOT NULL, trip_number VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO travel_group (id, delegation_id, arrival_or_departure, location, date_time, provider, trip_number, description, created_at, last_changed_at) SELECT id, delegation_id, arrival_or_departure, location, date_time, provider, trip_number, description, created_at, last_changed_at FROM __temp__travel_group');
        $this->addSql('DROP TABLE __temp__travel_group');
        $this->addSql('CREATE INDEX IDX_C56CC37356CBBCF5 ON travel_group (delegation_id)');
        $this->addSql('DROP INDEX UNIQ_8D93D649E7927C74');
        $this->addSql('DROP INDEX IDX_8D93D64956CBBCF5');
