 ...
 */
final class Version20210430114052 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE delegation ADD COLUMN languages CLOB DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__delegation AS SELECT id, name, registration_hash, created_at, last_changed_at, contestant_count, leader_count, guest_count, already_payed, participation_mode, attendance_review_progress, translations, delivery_address, contribution_review_progress FROM delegation');
