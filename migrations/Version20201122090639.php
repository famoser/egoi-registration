 ...
 */
final class Version20201122090639 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE delegation ADD COLUMN already_payed INTEGER DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__delegation AS SELECT id, name, registration_hash, created_at, last_changed_at, contestant_count, leader_count, guest_count, participation_mode, attendance_review_progress, translations, contribution_review_progress FROM delegation');
        ...
        $this->addSql('INSERT INTO delegation (id, name, registration_hash, created_at, last_changed_at, contestant_count, leader_count, guest_count, participation_mode, attendance_review_progress, translations, contribution_review_progress) SELECT id, name, registration_hash, created_at, last_changed_at, contestant_count, leader_count, guest_count, participation_mode, attendance_review_progress, translations, contribution_review_progress FROM __temp__delegation');
        ...
        $this->addSql('DROP INDEX IDX_D79F6B113E0872DC');
        $this->addSql('DROP INDEX IDX_D79F6B113F2C9D61');
        $this->addSql('CREATE TEMPORARY TABLE __temp__participant AS SELECT id, delegation_id, arrival_travel_group_id, departure_travel_group_id, role, created_at, last_changed_at, phone, given_name, family_name, birthday, email, gender, name_on_documents, portrait, papers, consent, personal_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, country_of_residence, place_of_birth, immigration_review_progress, shirt_size, shirt_fit, diet, allergies, single_room, event_presence_review_progress FROM participant');
        $this->addSql('DROP TABLE participant');
        ...
        , role INTEGER NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, phone CLOB DEFAULT NULL, given_name CLOB DEFAULT NULL, family_name CLOB DEFAULT NULL, birthday DATETIME DEFAULT NULL, email CLOB DEFAULT NULL, name_on_documents CLOB DEFAULT NULL, portrait CLOB DEFAULT NULL, papers CLOB DEFAULT NULL, consent CLOB DEFAULT NULL, personal_data_review_progress INTEGER NOT NULL, nationality CLOB DEFAULT NULL, passport_number CLOB DEFAULT NULL, passport_validity_from DATE DEFAULT NULL, passport_validity_to DATE DEFAULT NULL, passport_issue_country CLOB DEFAULT NULL, country_of_residence CLOB DEFAULT NULL, place_of_birth CLOB DEFAULT NULL, immigration_review_progress INTEGER NOT NULL, shirt_size INTEGER DEFAULT NULL, shirt_fit INTEGER DEFAULT NULL, diet CLOB DEFAULT NULL, allergies CLOB DEFAULT NULL, single_room BOOLEAN DEFAULT NULL, event_presence_review_progress INTEGER NOT NULL, gender CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO participant (id, delegation_id, arrival_travel_group_id, departure_travel_group_id, role, created_at, last_changed_at, phone, given_name, family_name, birthday, email, gender, name_on_documents, portrait, papers, consent, personal_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, country_of_residence, place_of_birth, immigration_review_progress, shirt_size, shirt_fit, diet, allergies, single_room, event_presence_review_progress) SELECT id, delegation_id, arrival_travel_group_id, departure_travel_group_id, role, created_at, last_changed_at, phone, given_name, family_name, birthday, email, gender, name_on_documents, portrait, papers, consent, personal_data_review_progress, nationality, passport_number, passport_validity_from, passport_validity_to, passport_issue_country, country_of_residence, place_of_birth, immigration_review_progress, shirt_size, shirt_fit, diet, allergies, single_room, event_presence_review_progress FROM __temp__participant');
        $this->addSql('DROP TABLE __temp__participant');
        $this->addSql('CREATE INDEX IDX_D79F6B1156CBBCF5 ON participant (delegation_id)');
        $this->addSql('CREATE INDEX IDX_D79F6B113E0872DC ON participant (arrival_travel_group_id)');
