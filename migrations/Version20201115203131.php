 ...
 */
final class Version20201115203131 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__travel_group AS SELECT id, delegation_id, arrival_or_departure, location, date_time, created_at, last_changed_at, provider, description, trip_number, review_progress FROM travel_group');
        $this->addSql('DROP TABLE travel_group');
        $this->addSql('CREATE TABLE travel_group (id CHAR(36) NOT NULL COLLATE BINARY --(DC2Type:guid)
        , delegation_id CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
        , arrival_or_departure INTEGER NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, review_progress INTEGER NOT NULL, location VARCHAR(255) DEFAULT NULL, date_time DATETIME DEFAULT NULL, provider VARCHAR(255) DEFAULT NULL, trip_number VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_C56CC37356CBBCF5 FOREIGN KEY (delegation_id) REFERENCES delegation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO travel_group (id, delegation_id, arrival_or_departure, location, date_time, created_at, last_changed_at, provider, description, trip_number, review_progress) SELECT id, delegation_id, arrival_or_departure, location, date_time, created_at, last_changed_at, provider, description, trip_number, review_progress FROM __temp__travel_group');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , delegation_id CHAR(36) DEFAULT NULL --(DC2Type:guid)
        , arrival_or_departure INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL, review_progress INTEGER NOT NULL, created_at DATETIME NOT NULL, last_changed_at DATETIME NOT NULL, location VARCHAR(255) NOT NULL COLLATE BINARY, date_time DATETIME NOT NULL, provider VARCHAR(255) NOT NULL COLLATE BINARY, trip_number VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
